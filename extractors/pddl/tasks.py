...
class Task(object):
    def __init__(self, domain_name, task_name, requirements,
                 types, constants, objects, predicates, functions, init, goal, actions, axioms, use_metric):
    ...
    def parse(domain_pddl, task_pddl):
        ...
        return Task(domain_name, task_name, requirements, types, constants, objects,
...
class Requirements(object):
    def __init__(self, requirements):
        ...
        for req in requirements:
	      ...
	      ":object-fluents", ":numeric-fluents", ":fluents",
	      ":durative-actions", ":duration-inequalities", ":continuous-effects",
	      ":timed-initial-literals", ":preferences", ":constraints", ":domain-axioms", ":safety-constraints"), req
    def __str__(self):
